...
if(isset($_POST['addCategory'])){
    if(!empty(trim($_POST['title']))  && !empty(trim($_FILES['image']['name'])) ){
        $title= $_POST['title'];
       ...
       $categoryInsert= $db->prepare("INSERT INTO categories (title,image) VALUES (:title,:image)");
       $categoryInsert->execute(['title'=>$title, 'image'=> $image]);

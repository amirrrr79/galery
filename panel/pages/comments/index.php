        ...
        $id=$_GET['id'];
           ...
           if($action=="delete"){
            ...
            exit();
                ...
                $commentUpdate=$db->prepare("UPDATE comments SET status='1' WHERE id = :id");
                $commentUpdate->execute(['id'=> $id]);
                header("Location:index.php");
                exit();
            }
        }
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($comment['status']) : ?>
                                                ...
                                                <?php else : ?>
                                            <a
                                                href="index.php?action=confirm&id=<?php echo  $comment['id'] ?>"
                                                class="btn btn-sm btn-outline-dark"
                                                >در انتظار تاییید</a
                                            >
                                            <?php endif ?>
                                            <a
                                                href="index.php?action=delete&id=<?php echo  $comment['id'] ?>"

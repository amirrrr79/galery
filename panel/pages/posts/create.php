...
if(isset($_POST['addPost'])){
    if(!empty(trim($_POST['title'])) && !empty(trim($_POST['lenght'])) && !empty(trim($_POST['teqnic'])) && !empty(trim($_POST['price'])) && !empty(trim($_POST['designer'])) && !empty(trim($_POST['body'])) && !empty(trim($_POST['category'])) && !empty(trim($_FILES['image']['name']))){
       ...
       $postInsert= $db->prepare("INSERT INTO posts (title,designer,category_id,price,Length,body,image) VALUES (:title,:designer,:category_id,:price,:Length,:body,:image)");
       $postInsert->execute(['title'=>$title, 'designer'=> $designer, 'category_id'=> $category,'price'=>$price, 'Length'=>$lenght ,'body'=>$body , 'image'=> $image]);
                    ...
                    <div class="mt-4">
                        <form method="POST" enctype="multipart/form-data" class="row g-4">
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="teqnic" class="form-control" />
                            </div>
